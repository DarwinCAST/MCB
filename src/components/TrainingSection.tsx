    ...
    <div className="max-w-7xl mx-auto px-4 py-12 space-y-16">
      ...
      <section>
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
          ...
          <Card className="border-2 hover:shadow-lg transition-shadow">
            ...
            <CardContent>
              <p className="text-slate-600 text-lg">
                Metodologías modernas y herramientas pedagógicas actualizadas
          ...
          <Card className="border-2 hover:shadow-lg transition-shadow">
            ...
            <CardContent>
              <p className="text-slate-600 text-lg">
                Capacidades para desarrollar guías pedagógicas que facilitan el
      ...
      >
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-slate-600 max-w-4xl mx-auto text-pretty">
            Metodología participativa y dialógica que motiva la reflexión y
            análisis según necesidades específicas
          </p>
        </div>
            ...
            <CardContent className="space-y-4">
              <div className="bg-slate-50 p-4 rounded-lg">
                <h4 className="font-semibold mb-2 text-lg">
                  Dinámica de la Pelota (10 min)
                </h4>
                <p className="text-base text-slate-600">
                  Presentación bajo esquema: Nombre, comunidad, puesto,
              ...
              <div className="bg-slate-50 p-4 rounded-lg">
                ...
                <p className="text-base text-slate-600">
                  Participantes escriben en tarjetas individuales sobre
                  liderazgo, mejores prácticas y herramientas administrativas
                </p>
              </div>
            </CardContent>
          </Card>
            ...
            <CardContent>
              <div className="space-y-3">
                ...
                <p className="text-slate-600 text-base">
                  El facilitador expone conceptos en PowerPoint con
                  visualización en pantalla
                </p>
                <p className="text-slate-600 text-base">
                  Los participantes pueden realizar comentarios y preguntas en
                  todo momento para mantener el diálogo
                </p>
              </div>
            </CardContent>
          </Card>
            ...
            <div className="grid md:grid-cols-2 gap-6">
              ...
              <div className="space-y-4">
                ...
                <p className="text-slate-600">
                  Se tomarán en consideración todas las recomendaciones de los
                  participantes para mejorar continuamente nuestros programas de
                  capacitación.
                </p>
              </div>
            </div>
            ...
            <CardContent className="pt-8">
              <div className="grid md:grid-cols-2 gap-8">
                <div className="text-center">
                  ...
                  <p className="text-slate-600">
                    Cierre formal del taller con síntesis de aprendizajes y
                    próximos pasos
                  </p>
                </div>
                <div className="text-center">
                  ...
                  <p className="text-slate-600">
                    Sección dedicada para resolver dudas y profundizar en temas
                    específicos
                  </p>
                </div>
              </div>
            ...
            <div className="grid md:grid-cols-2 gap-8">
              ...
              <div className="text-center">
                ...
                <p className="text-sm text-slate-500 mt-3">
                  Contacta con nuestros especialistas para una propuesta
                  personalizada
                </p>
              </div>
            </div>
